...
plugins=(git mercurial command-not-found django docker extract fabric history history-substring-search mosh pip python svn tmux tmuxinator vi-mode virtualenv virtualenvwrapper vundle)
